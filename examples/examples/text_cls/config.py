...
def parse_args():
    parser = argparse.ArgumentParser(description="baseline for multi cls task")

    parser.add_argument("--seed", type=int, default=727, help="random seed.")
    ...
    parser.add_argument('--train_zip_feats', type=str, default='data/labeled.zip')
    parser.add_argument('--test_zip_feats', type=str, default='data/test_a.zip')
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='save/v_peipao')
    ...
    parser.add_argument("--attack_func", default='pgd', type=str)
    parser.add_argument("--pgd_k", default=3, type=int)

    # ========================== Title BERT =============================
    parser.add_argument('--bert_dir', type=str, default='/home/hadoop-grocery-rc/yxfk/work_dir/gutianyi/nlp/bert_models/chinese-roberta-wwm-ext')
